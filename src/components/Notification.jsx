...
const Notification = () => {
  return (
    <div className="bg-blue-500 md:h-10 lg:h-10 h-20 w-full flex items-center justify-between font-roboto">
      ...
      <div>
        ...
        <FontAwesomeIcon icon={faX} className='text-white font-extralight hidden md:inline  mr-2 cursor-pointer'/>
      </div>
    </div>
  );
};
