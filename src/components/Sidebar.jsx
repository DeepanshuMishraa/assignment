...
const Sidebar = () => {
  ...
  return (
    ...
    <FontAwesomeIcon icon={faBars}  onClick={()=>setBar(!bar)}  className='ml-3 p-2  bg-gray-100 lg:hidden' />
    </div>
    {bar && <div className="md:w-[20rem] lg:w-[20rem] w-[23.5rem] bg-gray-100 h-full font-mons">
