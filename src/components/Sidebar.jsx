...
import { faArchive, faBell, faBook, faCircleHalfStroke, faClock, faClockFour, faCommentDollar, faHand, faLock, faSearch, faShapes, faSortDown, faUserPlus} from '@fortawesome/free-solid-svg-icons';
import profile from '../assets/profile.jpg';
import { Clock9 } from 'lucide';

const Sidebar = () => {
  return (
    <div className="w-[20rem] bg-gray-100 h-full font-mons">
